...
public class pillremindernewdb {
    ...
    // database name
    private static final String DATABASE_NAME="PillRemindernewDB";
    ...
    private pillremindernewdb.DBHelper ourHelper;
    ...
    public pillremindernewdb(Context context)
    {
        ourContext=context;
    }
    ...
    public pillremindernewdb open() throws SQLException
    {
        ourHelper=new pillremindernewdb.DBHelper(ourContext);
        ourDatabase=ourHelper.getWritableDatabase();
        return pillremindernewdb.this;
    }
